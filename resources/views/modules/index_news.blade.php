<div class="separator">            
    <article class="noticias">
        ...
        <div class="noticia" id="noticia_1">
            <div class="noticiaContent">
                ...
                <div class="buttonContainerRead">
                    <button id="buttonRead_1"><a href="#" id="buttonReadA_1">Leer mas</a></button>
                </div>
            </div>
        </div>
        ...
        <div class="noticia" id="noticia_2">
            ...
            <div class="buttonContainerRead">
                <button id="buttonRead_2"><a href="#" id="buttonReadA_2">Leer mas</a></button>
            </div>
        </div>
        ...
        <div class="noticia" id="noticia_3">
            ...
            <div class="buttonContainerRead">
                <button id="buttonRead_3"><a href="#" id="buttonReadA_3">Leer mas</a></button>
            </div>
        </div>
        ...
        <div class="noticia" id="noticia_4">
            ...
            <div class="buttonContainerRead">
                <button id="buttonRead_4"><a href="#" id="buttonReadA_4">Leer mas</a></button>
            </div>
        </div>
    ...
    <article class="guias">
        ...
        <div class="containerTags">
            <a  class="tags" href="#">Quest</a>
            <a  class="tags" href="#">Creacion</a>
            <a  class="tags" href="#">Personaje</a>
            <a  class="tags" href="#">Server</a>
            <a  class="tags" href="#">Items</a>
            <a  class="tags" href="#">Drops</a>
            <a  class="tags" href="#">Comandos</a>
            <a  class="tags" href="#">Reglas</a>
            <a  class="tags" href="#">Lorem</a>
